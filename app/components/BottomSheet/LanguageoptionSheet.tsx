...
const LanguageoptionSheet = ({moresheet,setLanguage} : Props) => {

    const theme = useTheme();
    const { colors } : {colors : any} = theme;

    return (
        <View style={[GlobalStyleSheet.container, { marginTop: 10,backgroundColor:theme.dark ?COLORS.title:COLORS.white }]}>
