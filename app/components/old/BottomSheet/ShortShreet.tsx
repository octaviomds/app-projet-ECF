...
const Short = (props, ref) => {
    ...
    const SortData = ["Rose", "Lily", "Tulip", "Daisy"];
    ...
    return (
        ...
        >
            <View style={[GlobalStyleSheet.container, { paddingTop: 0 }]}>
                ...
                >
                    <Text style={[FONTS.fontMedium, { color: colors.title, fontSize: 20 }]}>Sort By</Text>
                    <TouchableOpacity
                ...
                <View style={{ flexDirection: 'row', flexWrap: 'wrap', gap: 5, marginTop: 20 }}>
                    {SortData.map((data, index) => {
                        return (
                            ...
                            >
                                <Text style={[{ ...FONTS.fontRegular, fontSize: 16, color: colors.title }, activeSize === data && {  color: COLORS.white }]}>{data}</Text>
                            </TouchableOpacity>
                        )
                    })}
                </View>
...
export default forwardRef(Short);