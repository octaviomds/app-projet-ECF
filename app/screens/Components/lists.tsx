                    ...
                    <View style={[GlobalStyleSheet.card,{backgroundColor:theme.dark ?colors.card:colors.background}]}>
                        ...
                        <View style={[GlobalStyleSheet.card,{backgroundColor:theme.dark ?colors.card:colors.background}]}>
                            ...
                            <View style={GlobalStyleSheet.cardBody}>
                                <ListStyle1 
                                    arrowRight 
                                    icon={<Feather name={'shopping-cart'} size={15} color={colors.title} />}
                                    title={'Cart Checkout Sheet'}
                                />
                                <ListStyle1 
                                    arrowRight 
                                    icon={<Feather name={'check-circle'} size={15} color={colors.title} />}
                                    title={'Success Sheet'}
                                />
                                <ListStyle1 
                                    arrowRight
                                    icon={<Feather name={'log-out'} size={15} color={colors.title} />} 
                                    title={'Login Sheet'}
                                />
                                <ListStyle1 
                                    arrowRight 
                                    icon={<Feather name={'file-text'} size={15} color={colors.title} />}
