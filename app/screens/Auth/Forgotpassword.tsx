        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
            <View style={[GlobalStyleSheet.container,{padding:0}]}>
                <View style={{height:undefined,width:'100%',aspectRatio:1/.5,backgroundColor:COLORS.secondary,borderBottomLeftRadius:40,borderBottomRightRadius:40}}>
                    ...
                    <View style={{position:'absolute',height:'100%',width:'100%',left:Platform.OS === 'android' ? 40 : 30,top:Platform.OS === 'android' ? -55 : 0}}>
                        <Image
                            style={{height:Platform.OS === 'android' ? '190%':'140%',width:'100%',aspectRatio:1/1,resizeMode:'contain'}}
                            source={IMAGES.item3}
                        />
                    </View>
                </View>
            ...
            <View style={{flex:1}}>
                <View style={[GlobalStyleSheet.container,{paddingHorizontal:20}]}>
                    <View style={{marginTop:60}}>
                        <Text style={[FONTS.fontMedium,{fontSize:24,color:colors.title}]}>Forgot Password</Text>
                        <Text style={[FONTS.fontRegular,{fontSize:15,color:colors.title}]}>Enter the email associated with your account and we'll send and email to reset your password</Text>
                    </View>
